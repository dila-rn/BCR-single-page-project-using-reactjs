...
const Cards = () => {
  ...
  return (
          ...
          <div className="d-flex justify-content-center p-5">
            <div className="search-rectangle p-4" style={{ position: "relative", marginTop: "-3%" }}>
              <form className="row p-2" onSubmit={(event) => onEventSubmitFilter(event)}>
                ...
                <div className="col-lg-2 col-md-5 col-12 p-2">
                ...
                <div className="col-lg-1 col-md-3 col-12 p-2 d-flex align-items-end">
    ...
    <div className="d-flex justify-content-center row px-5">{
        cars.map((car, index) => {
          return (
            <div key={index} className="col-sm-12 col-md-6 col-lg-4 px-2">
              <div className="card p-4 my-3 mx-1">
                <div className={styles.eqHeight}>
                  ...
                  <div className={styles.eqHeightDesc}>
